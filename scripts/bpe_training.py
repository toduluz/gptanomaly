...
# Base tokenizer
tokenizer = AutoTokenizer.from_pretrained(args.base_tokenizer, model_max_length=args.model_max_length)
...
new_tokenizer.save_pretrained("outputs/" + args.dataset_name + "/" + args.tokenizer_name + "_tokenizer")
