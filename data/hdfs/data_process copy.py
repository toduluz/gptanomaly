...
def process_dataset(data_dir, output_dir, log_file, dataset_name, window_type, window_size, step_size, train_size,
    ...
    train_normal.to_csv(output_dir + "train.csv", index=False)
...
if __name__ == '__main__':
    ...
    parse_log(input_dir, "./", "HDFS.log", "drain", log_format, regex)
    process_dataset(data_dir="./", output_dir="./", log_file="HDFS.log", dataset_name="hdfs",
                    window_type="session", window_size=20, step_size=20, train_size=0.8, random_sample=False,
                    session_type="entry")