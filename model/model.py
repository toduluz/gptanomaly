...
# @dataclass
# class LogAnomalyOutput(ModelOutput):
...
# class LogAnomalyConfig(PretrainedConfig):
#     def __init__(
#         self,
...
class LogAnomalyClsHead(nn.Module):
...
# class LogAnomalyModel(RobertaPreTrainedModel):
...
class Discriminator(nn.Module):
    def __init__(self, hidden_size = 768, dropout = 0.1):
        ...
        self.cls_head = LogAnomalyClsHead()
